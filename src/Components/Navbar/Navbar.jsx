...
const Navbar = () => {
    ...
    const { getTotalcarts, theme, setTheme } = useContext(ShopContext);
        ...
        <div className={`navbar`} id="nav">
            <div className="nav-logo">
                <Link className="nav-logo-link" to="/">
                    ...
                    <p className={`pnav_${theme}`}>BrandWatch</p>
                </Link>
            </div>
            ...
            <div className="nav-login-cart">
                <Link to='/login'><button className='log_btn'>SignUp</button></Link>
